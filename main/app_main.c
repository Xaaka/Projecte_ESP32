...
static void mqtt5_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_publish(client, "/APP_AX", "XENIXEN", 0, 1, 1);
...
//        ESP_LOGI(TAG, "sent subscribe successful, msg_id=%d", msg_id);
        ...
        msg_id = esp_mqtt_client_subscribe(client, "/ESP32_AX", 2);
...
//        unsubscribe_property.user_property = NULL;
    ...
    case MQTT_EVENT_SUBSCRIBED:
        ...
        print_user_property(event->property->user_property);
        esp_mqtt5_client_set_publish_property(client, &publish_property);
        msg_id = esp_mqtt_client_publish(client, "/ESP32_AX", "OK_REBUT", 0, 0, 0);
        ESP_LOGI(TAG, "sent publish successful, msg_id=%d", msg_id);
        break;
...
/*        print_user_property(event->property->user_property);
    ...
    case MQTT_EVENT_DATA:
        ...
        ESP_LOGI(TAG, "MQTT_EVENT_AX_RESPONSE");
        print_user_property(event->property->user_property);
        esp_mqtt5_client_set_user_property(&publish_property.user_property, user_property_arr, USE_PROPERTY_ARR_SIZE);
        esp_mqtt5_client_set_publish_property(client, &publish_property);
        msg_id = esp_mqtt_client_publish(client, "/APP_AX", "XENIXEN OK", 0, 1, 1);
        esp_mqtt5_client_delete_user_property(publish_property.user_property);
        publish_property.user_property = NULL;
        ESP_LOGI(TAG, "sent publish successful, msg_id=%d", msg_id);
...
static void mqtt5_app_start(void)
{
    ...
    esp_mqtt_client_config_t mqtt5_cfg = {
        ...
        .network.disable_auto_reconnect = false,//XBB true
